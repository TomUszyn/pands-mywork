...
if percentage < 0 or percentage > 100:                 # Checks if we are inside expected range.
    print("Please enter a number between 0 and 100")   # If not inform to use correct number.
elif percentage < 40:                                  # Range between 0 and 39.
    print("Fail")                                      # Prints out Fail.
elif percentage < 50:                                  # Range between 40 and 49.
    print("Pass")                                      # Prints out Pass.
elif percentage < 60:                                  # Range between 50 and 59.
    print("Merit 2")                                   # Prints out Merit 2.
elif percentage < 70:                                  # Range between 60 and 69.
